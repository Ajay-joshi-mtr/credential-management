    ...
    <form class="form-horizontal" action="{{route('user.store')}}" method="post">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="eid" name='eid' placeholder="E ID Here">
                    @error('eid')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="tel" class="form-control" id="phone" name='phone' placeholder="Contact No Here">
                    @error('phone')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
